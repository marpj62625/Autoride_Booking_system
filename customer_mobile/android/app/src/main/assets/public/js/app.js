...
function openBookingForm(vehicleId) {
  ...
  el.innerHTML = '<div class="page-header">' +
    '<button class="back-btn" onclick="console.log(\'[DEBUG] Back button clicked\'); closeOverlay(\'page-booking-form\'); console.log(\'[DEBUG] Booking form closed\'); var vd=document.getElementById(\'page-vehicle-detail\'); console.log(\'[DEBUG] Vehicle detail element:\', vd); if(vd){console.log(\'[DEBUG] Vehicle detail exists, showing it\'); vd.style.display=\'block\'; vd.classList.add(\'active\'); console.log(\'[DEBUG] Vehicle detail display:\', vd.style.display, \'active:\', vd.classList.contains(\'active\')); var content=document.getElementById(\'vehicleDetailContent\'); console.log(\'[DEBUG] Vehicle detail content:\', content ? content.innerHTML.substring(0,100) : \'NOT FOUND\');} else {console.log(\'[DEBUG] Vehicle detail NOT FOUND!\');} var vehicles=document.getElementById(\'page-vehicles\'); console.log(\'[DEBUG] Vehicles page:\', vehicles, \'active:\', vehicles ? vehicles.classList.contains(\'active\') : \'N/A\');"><i class="fas fa-arrow-left"></i></button>' +
