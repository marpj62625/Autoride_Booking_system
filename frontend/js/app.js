...
var INSURANCE_OPTIONS = [
  ...
  { type: 'Standard Protection', pricePerDay: 500, desc: 'Collision Damage Waiver (CDW) with PHP 10k deductible.' },
...
function openBookingForm(vehicleId) {
  ...
  var insuranceHtml = INSURANCE_OPTIONS.map(function(ins, i) {
    ...
    var priceLabel = ins.pricePerDay === 0 ? 'Included (FREE)' : 'PHP ' + ins.pricePerDay.toLocaleString() + '/day';
  ...
  var addonsHtml = ADDON_OPTIONS.map(function(addon, i) {
    ...
    return '<div class="option-card" id="addon_' + i + '" onclick="toggleAddon(' + i + ',this)">' +
      ...
      '<div><strong>' + addon.name + '</strong> <span style="color:var(--primary);font-weight:700;">PHP ' + addon.pricePerDay.toLocaleString() + '/day</span></div>' +
    ...
    '<div class="scroll-content" style="padding:20px;padding-bottom:40px;">' +
      ...
      '<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:24px;">' +
        ...
        '<div>' +
          ...
          '<div style="font-size:1rem;font-weight:700;color:var(--text-primary);">'+formatPHP(b.total_price)+'</div>' +
